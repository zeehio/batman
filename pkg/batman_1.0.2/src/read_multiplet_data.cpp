              ...
              for (unsigned int n2 = 0; n2<(*opts).st.size(); n2++)
                {
                    ...
                    if ((c5[it][0]+50)<0.0000001)
                    {
                        ...
                        {
                            if (c1[it][0]<ped+(15.0*(*opts).centre_shape)+c7[it][0]
                            && c1[it][0]>pst-(15.0*(*opts).centre_shape)-c7[it][0])
                            {
                            //cout<<c1[it][0];
                            count = 1;
                            }  
                        } else {
                            if (c1[it][0]<ped+(15.0*(*opts).centre_shape)+(*opts).rdelta
                            && c1[it][0]>pst-(15.0*(*opts).centre_shape)-(*opts).rdelta)
                            {
                            //cout<<c1[it][0];
                            count = 1;
                            }
                        ...
                        if (!((c7[it][0]+50)<0.0000001))
                        {
                            if (c5[it][0]<ped+(15.0*(*opts).centre_shape)+c7[it][0]
                            && c5[it][0]>pst-(15.0*(*opts).centre_shape)-c7[it][0])
                            {
                            //cout<<c1[it][0];
                            count = 1;
                            }  
                        } else {
                            if (c5[it][0]<ped+(15.0*(*opts).centre_shape)+(*opts).rdelta
                            && c5[it][0]>pst-(15.0*(*opts).centre_shape)-(*opts).rdelta)
                            {
                            //cout<<c1[it][0];
                            count = 1;
                            }
