      ...
      {    
        ...
        if (length(gapsize) > 2) {
          ...
          if (listMeta && nometa)
          {
            ...
            lines(BM$sFit[pind[littleones],i],ytmp[littleones],col=plotColour[mind], lwd = metaTmplwd, lty = metaTmplty)
            for (ig in 1:lgo)
              lines(BM$sFit[pind[middleones[[ig]]],i]-middif[ig],ytmp[middleones[[ig]]],col=plotColour[mind], lwd = metaTmplwd, lty = metaTmplty)
            lines(BM$sFit[pind[bigones],i]-maxdif,ytmp[bigones],col=plotColour[mind], lwd = metaTmplwd, lty = metaTmplty)
            
            legend(placeLegend, c("Original Spectrum", "Metabolites Fit", "Wavelet Fit", "Fit Sum",
                                  row.names(BM$beta)[mind]), col=c(4,3,2,1,plotColour[mind]), cex = cex,
          ...
          if (listMeta && nometa)
          {
            ...
            ytmp <- BM$beta[mind,j]*BM$metaTemp[pind,mind+(j-1)*nrow(BM$beta)]
            lines(BM$sFit[pind[littleones],i],ytmp[littleones],col=plotColour[mind], lwd = metaTmplwd, lty = metaTmplty)
            lines(BM$sFit[pind[bigones],i]-(gapsize[1]),ytmp[bigones],col=plotColour[mind], lwd = metaTmplwd, lty = metaTmplty)
        ...
        if (listMeta && nometa)
        {
          ...
          ## plot named metabolite
          lines(BM$sFit[pind,i],BM$beta[mind,j]*BM$metaTemp[pind,mind+(j-1)*nrow(BM$beta)],col=plotColour[mind], lwd = metaTmplwd, lty = metaTmplty )
      ...
      {    
        ...
        if (length(gapsize) > 2) {
          ...
          if (listMeta && nometa)
          {
            ...
            lines(BM$sFitRerun[pind[littleones],i],ytmp[littleones],col=plotColour[mind], lwd = metaTmplwd, lty = metaTmplty)
            for (ig in 1:lgo)
              lines(BM$sFitRerun[pind[middleones[[ig]]],i]-middif[ig],ytmp[middleones[[ig]]],col=plotColour[mind], lwd = metaTmplwd, lty = metaTmplty)
            lines(BM$sFitRerun[pind[bigones],i]-maxdif,ytmp[bigones],col=plotColour[mind], lwd = metaTmplwd, lty = metaTmplty)
            
            legend(placeLegend, c("Original Spectrum", "Metabolites Fit", "Wavelet Fit", "Fit Sum",
                                  row.names(BM$betaRerun)[mind]), col=c(4,3,2,1,plotColour[mind]), cex = cex,
                   lty=c(1,1,1,1,rep(metaTmplty, length(mind))),lwd = c(0.5,0.5,0.5,0.5,rep(metaTmplwd, length(mind))))
          } else {
            legend(placeLegend, c("Original Spectrum", "Metabolites Fit", "Wavelet Fit", "Fit Sum"), col=c(4,3,2,1), 
                   lty=c(1,1,1,1),lwd = c(0.5,0.5,0.5,0.5), cex = cex)
          ...
          if (listMeta && nometa)
          {
            ...
            ytmp <- BM$betaRerun[mind,j]*BM$metaTempRerun[pind,mind+(j-1)*nrow(BM$betaRerun)]
            lines(BM$sFitRerun[pind[littleones],i],ytmp[littleones],col=plotColour[mind], lwd = metaTmplwd, lty = metaTmplty)
            lines(BM$sFitRerun[pind[bigones],i]-(gapsize[1]),ytmp[bigones],col=plotColour[mind], lwd = metaTmplwd, lty = metaTmplty)
        ...
        if (listMeta  && nometa)
        {
          ...
          ## plot named metabolite
          lines(BM$sFitRerun[pind,i],BM$betaRerun[mind,j]*BM$metaTempRerun[pind,mind+(j-1)*nrow(BM$betaRerun)],col=plotColour[mind], lwd = metaTmplwd, lty = metaTmplty )
          legend(placeLegend, c("Original Spectrum", "Metabolites Fit", "Wavelet Fit", "Fit Sum",
                                row.names(BM$betaRerun)[mind]), col=c(4,3,2,1,plotColour[mind]), cex = cex,
                 lty=c(1,1,1,1,rep(metaTmplty, length(mind))),lwd = c(0.5,0.5,0.5,0.5,rep(metaTmplwd, length(mind))))
        } else {
